<html>
    ...
    <body>
       ...
       <!--NAVBAR START-->
        ...
        <!--TUTORIAL START-->
        <div id="tutorial" class="offset container mt-5 mb-5">
        <div class="post-heading text-center">
            <h3 class="display-4 font-weight-bold">TUTORIAL</h3>
            <hr class="w-50 mx-auto mb-5">
        </div>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12 pb-4">
            <img src="train.jpg" class="img-fluid">
            </div>

            <div class="col-lg-6 col-md-6 col-12">
            <h2>How to buy train ticket at PNROTS</h2>
            <hr>
            <p>
        ...
        <!--ABOUT START-->
        <div id="about" class="offset container mt-5 mb-5">
        <div class="post-heading text-center">
            <h3 class="display-4 font-weight-bold">ABOUT PNROTS</h3>
            <hr class="w-50 mx-auto mb-5">
        </div>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12 pb-4">
